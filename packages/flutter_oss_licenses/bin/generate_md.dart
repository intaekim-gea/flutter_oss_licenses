...
main(List<String> args) async {
  ...
  try {
    ...
    final outputFilePath = results['output'] ?? path.join('.', 'oss_licenses.md');
    ...
    final packages = List<oss.Package>.from(
      jsonDecode(json).map(
        (e) => oss.Package(
          ...
          authors: e['authors'] != null ? List<String>.from(e['authors']) : [],
    ...
    if (metaFilePath != null) {
      ...
      final intermediate = Map<String, List<dynamic>>.from(jsonDecode(metaJson));
...
ArgParser getArgParser() {
  ...
  parser.addOption(
    ...
    abbr: 'i',
    defaultsTo: null,
    help: 'Specify input file path of JSON file that is including list of Package.',
  );
  parser.addOption(
    'output',
    abbr: 'o',
